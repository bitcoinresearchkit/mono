...
function sentimentSeries(u) {
  return [
    baseline({
      series: u.netSentiment.usd,
      name: "Net Sentiment",
      unit: Unit.usd,
    }),
    line({
      series: u.greedIndex.usd,
      name: "Greed Index",
      color: colors.profit,
      unit: Unit.usd,
      defaultActive: false,
    ...
    tree: [
      {
        ...
        bottom: mapCohortsWithAll(list, all, ({ name, color, tree }) =>
          baseline({
            series: tree.unrealized.netSentiment.usd,
            name,
            color,
            unit: Unit.usd,
          }),
      ...
      },
      {
        ...
        bottom: mapCohortsWithAll(list, all, ({ name, color, tree }) =>
          line({
            series: tree.unrealized.greedIndex.usd,
            name,
            color,
            unit: Unit.usd,
          }),
      ...
      },
      {
        ...
        bottom: mapCohortsWithAll(list, all, ({ name, color, tree }) =>
          line({
            series: tree.unrealized.painIndex.usd,
            name,
            color,
            unit: Unit.usd,
          }),
