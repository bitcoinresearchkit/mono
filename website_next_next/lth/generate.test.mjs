...
const expected = [
  'over_4m_awake_price_cents', 'over_4m_awake_capitalized_price_cents',
  'over_4m_coinflow_price_cents', 'over_4m_coinflow_capitalized_price_cents',
  'lth_awake_price_cents', 'lth_awake_capitalized_price_cents',
  'lth_coinflow_price_cents', 'lth_coinflow_capitalized_price_cents',
  'over_6m_awake_price_cents', 'over_6m_awake_capitalized_price_cents',
  'over_6m_coinflow_price_cents', 'over_6m_coinflow_capitalized_price_cents',
];
...
test('each of the 12 weighted prices can define the cloud, independently of candles', () => {
  ...
  assert.equal(snapshot.bounds, undefined);
...
test('standalone generator writes the partial day and preserves the snapshot on invalid inputs', async () => {
  const directory = await mkdtemp(join(tmpdir(), 'lth-weighted-'));
