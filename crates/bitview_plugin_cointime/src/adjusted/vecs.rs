...
pub struct Vecs<M: StorageMode = Rw> {
    /// Cointime-adjusted supply inflation rate: trailing 365-day circulating
    /// supply growth divided by starting supply, multiplied by `liveliness / (1
    /// - liveliness)`. Liveliness is cumulative coinblocks destroyed divided by
    /// cumulative coinblocks created. Returns NaN while starting supply is at
    /// most 50 BTC. Higher values combine faster supply growth with a larger
